printf
A simple printf function built by Abdulkadir Musa Adam and Abdulrahaman Isa Bawa for Alx software Engineering School.
...
Expletive: printf("%F", anything); Output: FORK
...
#Authors
Abdulkadir Musa Adam
Abdul-rahaman Isa Bawa
